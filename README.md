...
##
[Приложение на Heroku](https://ipresumes.herokuapp.com/resume)
###
[Сертификат BaseJava по итогам проекта](http://javaops.ru/certificate/basejava?email=ip-media@yandex.ru)
